...
public class TrelloService {
    ...
    public CreatedTrelloCardDto createTrelloBoards(final TrelloCardDto trelloCardDto) {
    ...
    public CreatedTrelloCardDto createTrelloCard(TrelloCardDto mapToCardDto) {
