...
//                .map(trelloBoardDto1 ->
//                        new TrelloBoard(trelloBoardDto1.getId(), trelloBoardDto1.getName(), mapToList(trelloBoardDto1.getLists())))
//                .collect(Collectors.toList());
//    }


//    //dlaczego nie chce mi zwrócić boleana dla isClosed tylko Lombok robi Stringowego gettersa ???
